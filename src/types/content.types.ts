...
export interface About extends BasePageConfig {
  ...
  technicalSkills: {
    ...
    /** Title for the technical skills section */
    title: string;
    /** List of technical skill groups */
    skills: Array<{
      /** Skill category title (e.g., Frontend, Backend, DevOps, etc.) */
      title: string;
      /** Optional description for the skill group */
      description?: React.ReactNode;
      /** Skill tags within the category */
      tags?: Array<{
        /** Name of the technology or tool */
        name: string;
        /** Optional icon name to visually represent the technology */
        icon?: string;
      }>;
      /** Images related to the skill category (optional) */
      images?: Array<{
        /** Image source path */
        src: string;
        /** Alternative text for accessibility */
        alt: string;
        /** Image width ratio (e.g., 16 for 16:9 aspect ratio) */
        width: number;
        /** Image height ratio (e.g., 9 for 16:9 aspect ratio) */
        height: number;
      }>;
    }>;
  };
